...
<%@ page import="com.project1.JobApp.model.JobPost" %>
<%@ page import="com.project1.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Tarik˙s Job Portal Web App</a>
